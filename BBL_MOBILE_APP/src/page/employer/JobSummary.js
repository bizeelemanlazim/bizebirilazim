...
export default function JobSummary() {
  return (
    <View style={{backgroundColor: Colors.BackgroundColor, flex: 1}}>
      <Header />
      <Breadcrumbs
        list={['Anasayfa', 'İlanlarım', 'İş Özeti']}
      ...
      <View style={{paddingHorizontal: 20}}>
        <Text style={{color: 'white', alignSelf: 'center', marginTop: 10}}>İş Özeti</Text>
        <ShadowBox
          style={{
            width: '100%',
            alignSelf: 'center',
        ...
        <CustomCheckBox 
            textComponent={<View style={{ flexDirection: 'row', marginLeft: 10 }}>
                <Text style={{ color: Colors.BlueGolge }}>Geçici İş Sözleşmesi</Text>
